...
if __name__ == "__main__":
    ...
    if keuze == 't':
        ...
        sim.addElement(GaussStimulus1D('obj 2', fieldSize, sigma_exc, 2, round((2/10)*fieldSize[1]), True, False))
        sim.addElement(GaussStimulus1D('obj 5', fieldSize, sigma_exc, 2, round((5/10)*fieldSize[1]), True, False))
        sim.addElement(GaussStimulus1D('obj 8', fieldSize, sigma_exc, 2, round((8/10)*fieldSize[1]), True, False))
    ...
    if keuze == 's':
        ...
        sim.addElement(GaussStimulus1D('obj 1', fieldSize, sigma_exc, 2, round((1/10)*fieldSize[1]), True, False))
        sim.addElement(GaussStimulus1D('obj 4', fieldSize, sigma_exc, 2, round((4/10)*fieldSize[1]), True, False))
        sim.addElement(GaussStimulus1D('obj 7', fieldSize, sigma_exc, 2, round((7/10)*fieldSize[1]), True, False))
    ...
    if keuze == 'c':
        ...
        sim.addElement(GaussStimulus1D('obj 3', fieldSize, sigma_exc, 2, round((3/10)*fieldSize[1]), True, False))
        sim.addElement(GaussStimulus1D('obj 6', fieldSize, sigma_exc, 2, round((6/10)*fieldSize[1]), True, False))    
        sim.addElement(GaussStimulus1D('obj 9', fieldSize, sigma_exc, 2, round((9/10)*fieldSize[1]), True, False))
